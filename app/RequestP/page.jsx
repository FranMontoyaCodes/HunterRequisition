        ...
        {selectedRequest && (
          <div className="mt-8 border p-4 rounded bg-white w-full max-w-4xl">
            ...
            <div className="flex items-center justify-center space-x-4 mb-4">
              <label htmlFor="name" className="w-24 text-right mr-2"></label>
              <input
                type="text"
                label="namev"
                id="name"
            ...
            <div className="flex items-center justify-center w-full mt-4">
              {stages.map((stage, index) => (
                <div key={index} className={`w-1/7 flex justify-center items-center ${index <= currentStage ? 'text-green-500' : 'text-gray-500'}`}>
                  {index <= currentStage && <AiFillCheckCircle className="text-lg" />}
